...
minit; 
mdocshow(mfilename, ['loads bottle salinities from the concatenated file specified in opt_' mcruise ' (generated by running msal_standardise_avg) and writes to sal_' mcruise '_' stn_string '.nc']);

% resolve root directories for various file types
root_sal = mgetdir('M_BOT_SAL');
otfile2 = [root_sal '/sal_' mcruise '_' stn_string];
scriptname = mfilename; oopt = 'saldatafile'; get_cropt %file to load
