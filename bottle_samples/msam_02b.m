...
mdocshow(mfilename, ['changes (where necessary) sample value flags in sam_' mcruise '_' stn_string '.nc, 1) as specified in bottle_data_flags.txt; 2) so they are consistent with Niskin flags']);
