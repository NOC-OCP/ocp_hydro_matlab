...
sqlname = vdef{1,1};
% sqlvars = 'extract(epoch from time)';
sqlvars = 'date_part(''epoch'',time)';

sqlunits = {'seconds_since_1970_01_01'};
...
sqlroot = ['psql -h ' MEXEC_G.RVDAS_MACHINE ' -U ' MEXEC_G.RVDAS_USER ' -d ' '"preJC211"'];
