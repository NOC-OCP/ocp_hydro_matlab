...
[sqlcom, fncsv, units] = mr_make_psql2(table,dv1,dv2,varstring); % it should be fine if varstring is empty
...
ts = ds.date_part;
dd.dnum = datenum([1970 1 1 0 0 0]) + ts/86400;
