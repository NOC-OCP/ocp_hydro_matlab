...
% %"GPGGA" %all now goes to single table/sentence for both rangers because
...
%"PSONLLD"
rtables.ranger2usbl_psonlld = {  % from usblpson-dy.json
...
%rex2-dy  1  sentences %not currently working
...
'sbe45_nanan'  5 []  % fields
     'tempH'                             ''                                                        'housingWaterTemperature'
                'conductivity'                             ''                                                                   'conductivity'
                    'salinity'                             ''                                                                       'salinity'
               'soundVelocity'                             ''                                                                  'soundVelocity'
      'tempR'              'degrees Celsius'                                                         'remoteWaterTemperature'
};
