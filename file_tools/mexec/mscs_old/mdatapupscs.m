...
% function mdatapup(startyy,startddd,starttime,endyy,endddd,endtime,flags,instream,otfile,varlist)
% function mdatapup(remote_machine,directory_r,directory_l,startyy,startddd,starttime,endyy,endddd,endtime,flags,instream,otfile,varlist)
%function mdatapup(remote_machine,directory_r,directory_l,startyy,startddd,starttime,endyy,endddd,endtime,flags,instream,otfile,varlist)
%
