...
MEXEC_G.mexec_data_root = '/data/pstar/projects/rpdmoc/cruise_data/dy204/mcruise/data/'; 
MEXEC_G.other_programs_root = {'/data/pstar/programs/others/matlab';'/data/pstar/programs/repos_github/athurnherr'}; 
MEXEC_G.mexec_shell_scripts = '/data/pstar/programs/repos_github/NOC-OCP/mexec_exec/';
