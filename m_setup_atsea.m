...
%   Updated by YLF jr16002 and jc145 to v3:
%     lots of simplification
%     quiet and ssd options
%     more automation of underway data directory setting

MEXEC.mexec_version = 'v3';
MEXEC.MSCRIPT_CRUISE_STRING='jc145';
MEXEC.MDEFAULT_DATA_TIME_ORIGIN = [2017 1 1 0 0 0];
...
MEXEC.mstar_root = '/local/users/pstar/cruise';
...
MEXEC_G.SITE = [MEXEC_G.MSCRIPT_CRUISE_STRING '_atsea']; % default is to use suffix '_atsea'
...
switch MEXEC_G.Mship
    ...
    case 'cook'
        ...
        MEXEC_G.default_hedstream = 'attsea'; %or gyropmv
...
switch MEXEC_G.Mshipdatasystem
   case 'techsas'
      ...
      MEXEC_G.uway_root = [MEXEC_G.MEXEC_DATA_ROOT '/techsas/netcdf_files'];
...
if ~exist([MEXEC.mexec_processing_scripts '/m_udirs.m'], 'file')
   m_setudir %create it
end
...
MEXEC_G.MDIRLIST = [MEXEC_G.MDIRLIST; {'M_POS' ['nav/' MEXEC_G.default_navstream]}];
...
if MEXEC.matnet == 0
    MEXEC.path_mexnc = [MEXEC.netcdf_root '/mexnc'];
    MEXEC.path_snctools = [MEXEC.netcdf_root '/snctools'];
else
    % extra setup for matlab native netcdf support
    setpref('MEXNC','USE_TMW',true);
    setpref('SNCTOOLS','USE_TMW',true);
    MEXEC.path_mexnc = [MEXEC.netcdf_root '/mexcdf/mexnc']; % for matlab 2009
    MEXEC.path_snctools = [MEXEC.netcdf_root '/mexcdf/snctools']; % for matlab 2009
end
