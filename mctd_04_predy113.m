% mctd_04: extract downcast and upcast data from 1hz _psal file using index information in dcs file; 
...
otfile1 = [root_ctd '/ctd_' mcruise '_' stn_string '_2db'];
otfile2 = [root_ctd '/ctd_' mcruise '_' stn_string '_2up'];
...
for kloop_scr = numcopy:-1:1
    if ~strncmp(var_copycell(kloop_scr),h_input.fldnam,length(var_copycell(kloop_scr)))
...
%calculate practical and absolute salinity
