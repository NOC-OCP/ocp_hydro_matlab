...
if nump == -1
    ...
    slist = stnl-nump:stnl-1;
    slist(slist<1) = [];
end

% stnl is now the local station number
...
if length(find(sused == stnl)) < 1
    msg = ['Station ' sprintf('%03d',stnl) ' was not loaded. Check all the files are available'];
    fprintf(2,'%s\n',msg)
end
