...
%     {'physics' 'nutsodv' 'nuts' 'co2' 'ch4' '1hz' 'firstlast'}
% 
% The common syntax 
...
options = {'physics' 'nutsodv' 'nuts' 'co2' 'ch4' '1hz' 'firstlast'};
...
for kloop = 1:length(choices)
    switch choices{kloop}
        case {'physics'}
            ...
            stn  = stnlocal; choice = 'physics'; list_bot_jr302; clear stn;
            kdone(1) = 1;
        case {'nutsodv'}
            if kdone(2) == 1; continue; end
            stn  = stnlocal; choice = 'nutsodv'; list_bot_jr302; clear stn;
            kdone(2) = 1;
        case {'nuts'}
            if kdone(3) == 1; continue; end
            stn  = stnlocal; choice = 'nuts'; list_bot_jr302; clear stn;
            kdone(3) = 1;
        case {'co2'}
            if kdone(4) == 1; continue; end
            stn  = stnlocal; choice = 'co2'; list_bot_jr302; clear stn;
            kdone(4) = 1;
        case {'ch4'}
            if kdone(5) == 1; continue; end
            stn  = stnlocal; choice = 'ch4'; list_bot_jr302; clear stn;
            kdone(5) = 1;
        case {'1hz'}
