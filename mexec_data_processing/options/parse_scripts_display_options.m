        ...
        switch opt2
            case 'rawedit_auto'
                crhelp_str = {'Several types of edits to the raw data (_raw or _raw_noctm) to be '
                    ...
                    'castopts.pumpsNaN.sbe_oxy2 = 8*24'
                    ' '
                    ...
                    'castopts.badtemp1.oxy1 = [-2 40; NaN NaN];'
                    '    NaNs temp1, cond1, oxy1 when press is <-1 or >8000, or is NaN,'
                    '    and then cond1 and oxy1 when temp1 is outside [-2 40] or is NaN '
                    ' '
        ...
        switch opt2
            ...
            case 'oxyvars'
                crhelp_str = {'oxyvars (default: {''oxygen_sbe1''; ''oxygen_sbe2''}) is a cell array listing the name(s) of ';
                    ...
                    'column accordingly.'};
                oxyvars = {'oxygen_sbe1' 'oxy1'; 'oxygen_sbe2' 'oxy2'};
            case 'oxy_align'
            ...
            case 'ctdsens_groups'
                crhelp_str = {'sg is a structure with fields corresponding to the CTD sensors e.g.'
                    'temp1, oxy1, temp2, etc. default is to load from a .mat file generated by get_sensor_groups.m.'
        ...
        switch opt2
            case 'ctd_cals'
                crhelp_str = {'Set calibration functions to be applied to variables in _24hz file, if '
                    ...
                    'Functions are set in castopts.calstr, a structure whose fields are sensors (e.g. cond1, oxy2),'
