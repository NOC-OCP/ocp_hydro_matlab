...
if typ==1 % this is for ctd profiles
    ...
    vars = {'CTDPRS', 'DBAR', 'press', '%8.1f'
        ...
        'CTDOXY','UMOL/KG', 'oxy', '%6.1f'
        'CTDOXY_FLAG_W', ' ', 'oxy_flag', '%d'
...
elseif typ==2 % this is for comparing with bottle samples
    ...
    vars = {'EXPOCODE', ' ', 'expocode', '%s'
        ...
        'CTDOXY', 'UMOL/KG', 'uoxy', '%6.1f'
        'CTDOXY_FLAG_W', ' ', 'uoxy_flag', '%d'
        'oxy', 'UMOL/KG', 'botoxy', '%6.1f'
        'oxy_FLAG_W', ' ', 'botoxy_flag', '%d'
...
%        'PAR', 'UMOL/M^2/SEC', 'upar_up', '%6.5f' %par_up is up-looking (downwelling)
        ...
        'NO2+NO3', 'UMOL/KG', 'totnit', '%8.3f'
        'NO2+NO3_FLAG_W', ' ', 'totnit_flag', '%d'
        'PHSPHT', 'UMOL/KG', 'phos', '%8.3f'
        'PHSPHT_FLAG_W', ' ', 'phos_flag', '%d'
        'AMMONI', 'UMOL/KG', 'amon', '%8.3f'
        'AMMONI_FLAG_W', ' ', 'amon_flag', '%d'
        ...
        'DELSI30', '/MILLE', 'del30si', '%8.4f'
        'DELSI30_FLAG_W', ' ', 'del30si_flag', '%d'
        'FE', 'NMOL/L', 'fe', '%7.4f'
        'FE_FLAG_W', ' ', 'fe_flag', '%d'
        'RA-226', 'DM/.1MG', 'ra226', '%7.4f'
