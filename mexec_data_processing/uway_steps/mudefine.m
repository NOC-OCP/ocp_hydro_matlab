...
if nargin>0 && strcmp(varargin{1},'redo')
    ...
    switch MEXEC_G.Mshipdatasystem
        ...
        case 'scs_ascii'
            ...
            mutv = {'seapath','nav','pos','GGA','Seapath-GGA*.Raw',{'latitude','longitude','ggaqual'};...
                'simrad','nav','pos','GGA','Simrad-GGA*.Raw',{'latitude','longitude','ggaqual'};...
                ...
                'fluor','ocean','tsg','','Fluorometer*.Raw',{'fluo'};...
                'sbe21','ocean','tsg','','SBE21*.Raw',{'psal','temp','fluo','m0','m1'};...
