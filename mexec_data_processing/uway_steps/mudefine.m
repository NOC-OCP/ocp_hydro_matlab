...
if nargin>0 && strcmp(varargin{1},'redo')
    ...
    switch MEXEC_G.Mshipdatasystem
        ...
        case 'scs_ascii'
            ...
            mutv = {'seapath','nav','pos','GGA','Seapath-GGA*.Raw',{'utctime','lat','lon','ggaqual'};...
                'simrad','nav','pos','GGA','Simrad-GGA*.Raw',{'utctime','lat','lon','ggaqual'};...
                ...
                'es18','bathy','sbm','','*ES18*.XYZ',{'lat','lon','depth'};...
                'es38','bathy','sbm','','*ES38*.XYZ',{'lat','lon','depth'};...
                'em2040','bathy','mbm','','*EM2040*.XYZ',{'lat','lon','depth'};...
                'em340','bathy','mbm','','*EM340*.XYZ',{'lat','lon','depth'};...
