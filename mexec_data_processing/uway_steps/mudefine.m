...
if nargin>0 && strcmp(varargin{1},'redo')
    ...
    switch MEXEC_G.Mshipdatasystem
        ...
        case 'scs_ascii'
            ...
            mutv = {'seapath','nav','pos','GGA','Seapath-GGA*.Raw',{'utctime','lat','lon','ggaqual','altitude'};...
                'simrad','nav','pos','GGA','Simrad-GGA*.Raw',{'utctime','lat','lon','ggaqual','altitude'};...
                'simrad','nav','shipmotion','VTG','Simrad-VTG*.Raw',{'tmg','speedkg','sog'};...
                %'mru','nav','att','PSXN','MRU*.Raw',{'roll','pitch','heading','heave'};...%all 0s
                'gyro','nav','head','HDT','Gyro-HDT*.Raw',{'head_true'};...
                'gyro','nav','shipmotion','ROT','Gyro-ROT*.Raw',{'rate_of_turn'};...
                'es18','bathy','fbm','','*ES18*.XYZ',{'lat','lon','depth'};...
                'es38','bathy','fbm','','*ES38*.XYZ',{'lat','lon','depth'};...
                'em2040','bathy','mbm','','*RV_Celtic_Explorer.csv',{'lat','lon','depth'};...
                'em340','bathy','mbm','','???_20260???_?????.csv',{'lat','lon','depth'};...
                'fluor','surfmet','tsg','','Fluorometer*.Raw',{'fluor'};...
                'sbe21','surfmet','tsg','','SBE21*.Raw',{'psal','temp_tsg','cond','temp_in'};...
                'smartguard','surfmet','tsg','PAAI','SooGuard*.Raw',setdiff(nmeas.PAAI(1,:),{'msg','checksum'});...
                'windtrue','surfmet','wind','WIMWD','Gill-WindDir*.Raw',{'winddir','windspd'};...
                'met','met','surfmet','CR6','CR6*.Raw',setdiff(nmeas.CR6(1,:),{'msg','timestamp'});...
                };
            mutv = cell2table(mutv,'VariableNames',{'mstarpre','mstardir','paramtype','nmeas_msg','scsfilepat','mstarvars'});
            mutv.tablenames = mutv.mstarpre;
            header = {' '};
