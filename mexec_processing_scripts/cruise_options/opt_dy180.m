    ...
    case 'ctd_proc'
        switch opt2
            ...
            case 'ctd_cals'
                ...
                co.calstr.cond.sn44065.msg = 'calibration for cond 04c-4065 (cond1) based on up to 55 good samples from 14 casts with stainless rosette';
                co.calstr.cond.sn44138.dy180 = 'dcal.cond = d0.cond.*(1-0.008/35);';
                co.calstr.cond.sn44138.msg = 'calibration for cond 04c-4138 (cond2) based on up to 55 good samples from 14 casts with stainless rosette';
                co.calstr.oxygen.sn2722.dy180 = 'dcal.oxygen = d0.oxygen.*interp1([0 1100],[1 1.005],d0.press).*interp1([1 52],[1.05 1.07],d0.statnum);';
                co.calstr.oxygen.sn2722.msg = 'calibration for oxy 2722 (oxygen2) based on up to 245 good samples from 26 casts with stainless rosette';
                ...
                co.calstr.oxygen.sn431882.msg = 'calibration for oxy 43-1882 (oxygen1) based on up to 245 good samples from 26 casts with stainless rosette';
