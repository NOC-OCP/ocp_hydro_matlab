...
% updated to call list_bot_dy040 on dy040 12 dec 2015; bak and elm
...
for kloop = 1:length(choices)
    switch choices{kloop}
        case {'physics'}
            ...
            stn  = stnlocal; choice = 'physics'; list_bot_dy040; clear stn;
            kdone(1) = 1;
        case {'allpsal'}
            if kdone(1) == 1; continue; end
            stn  = stnlocal; choice = 'allpsal'; list_bot_dy040; clear stn;
            kdone(1) = 1;
        case {'nutsodv'}
            if kdone(2) == 1; continue; end
            stn  = stnlocal; choice = 'nutsodv'; list_bot_dy040; clear stn;
            kdone(2) = 1;
        case {'nuts'}
            if kdone(3) == 1; continue; end
            stn  = stnlocal; choice = 'nuts'; list_bot_dy040; clear stn;
            kdone(3) = 1;
        case {'co2'}
            if kdone(4) == 1; continue; end
            stn  = stnlocal; choice = 'co2'; list_bot_dy040; clear stn;
            kdone(4) = 1;
        case {'ch4'}
            if kdone(5) == 1; continue; end
            stn  = stnlocal; choice = 'ch4'; list_bot_dy040; clear stn;
            kdone(5) = 1;
        case {'1hz'}
            if kdone(6) == 1; continue; end
            stn  = stnlocal; list_ctd_1hz(stn); clear stn;
            kdone(6) = 1;
        case {'firstlast'}
        ...
        case {'cfc'}
            ...
            stn  = stnlocal; choice = 'cfc'; list_bot_dy040; clear stn;
            kdone(8) = 1;
        otherwise
    end
end
