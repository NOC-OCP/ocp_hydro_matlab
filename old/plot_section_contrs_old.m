...
%         c.xax = [0 1500];
        ...
        c.labels = [0];
    case 'a2a1all'
        cmd = ['c.ncfile.name1 = ''grid_' MEXEC_G.MSCRIPT_CRUISE_STRING '_' 'labupper' '''']; eval(cmd);
        ...
        c.labels = [0];
    case 'labmain'
        cmd = ['c.ncfile.name1 = ''grid_' MEXEC_G.MSCRIPT_CRUISE_STRING '_' 'osnapwupper' '''']; eval(cmd);
    ...
    case 'labsouthshelf'
        ...
        c.labels = [0];
    case {'linec'}
        cmd = ['c.ncfile.name1 = ''ctd_' MEXEC_G.MSCRIPT_CRUISE_STRING '_' 'linecupper' '''']; eval(cmd);
        ...
        c.labels = [0];
    case 'arc'
        cmd = ['c.ncfile.name1 = ''grid_' MEXEC_G.MSCRIPT_CRUISE_STRING '_' 'arcupper' '''']; eval(cmd);
        ...
        c.labels = [0];
    case 'osnape'
        cmd = ['c.ncfile.name1 = ''grid_' MEXEC_G.MSCRIPT_CRUISE_STRING '_' 'osnapeupper' '''']; eval(cmd);
        ...
        c.labels = [0];
    case 'eel'
        cmd = ['c.ncfile.name1 = ''grid_' MEXEC_G.MSCRIPT_CRUISE_STRING '_' 'eelupper' '''']; eval(cmd);
