...
for kseq = 0:maxnumseq
    ...
    for kframes = 1:nframes
        ...
        utcmo = inframe(1516);
        utcdd = inframe(1515);
        utcfraclast = b4to1(inframe(1535:1538))/86400/10000; % fraction of a day since midnight
        utclast(kframes) = datenum([utcyyyy utcmo utcdd]) + utcfraclast;
    end
