function pdfot = m_edplot_ctd(pdfin,ncfile)

% This is all the work from mplotxy_ctd, but without the
% initialising call to proghd. Also called from mplxyed.
%
% see 'help mplotxy'
% modifed by ZBS on 22.10.09 to fix the sizing of the figure when exported
