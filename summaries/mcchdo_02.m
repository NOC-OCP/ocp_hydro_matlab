% mcchdo_02: write CCHDO exchange file for CTD data
% Use: mcchdo_02        
%
...
prefix3 = ['cchdo_ctd_' MEXEC_G.MSCRIPT_CRUISE_STRING '_'];

infile1 = [root_ctd '/' prefix2 stn_string '_2db'];
otfile1 = [root_ctd '/' prefix3 stn_string 'exchange.csv'];
...
sumfn = ['station_summary_' MEXEC_G.MSCRIPT_CRUISE_STRING '_all.nc'];
...
fotname = [outfile '_' sprintf('%05d',stnlocal) '_' '0001' '_ct1.csv'];
