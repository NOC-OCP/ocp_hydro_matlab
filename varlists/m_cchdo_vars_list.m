...
elseif typ==2 % this is for comparing with bottle samples
    ...
    vars = {'EXPOCODE', ' ', 'expocode', '%s'
        ...
        'NITRAT_FLAG_W', 'UMOL/KG', 'no3_flag', '%d'
        'NITRIT', 'UMOL/KG', 'no2', '%8.2f'
        'NITRIT_FLAG_W', 'UMOL/KG', 'no2_flag', '%d'
        'NO2+NO3', 'UMOL/KG', 'totnit', '%8.2f'
        'NO2+NO3_FLAG_W', 'UMOL/KG', 'totnit_flag', '%d'
        'PHSPHT', 'UMOL/KG', 'phos', '%8.2f'
        'PHSPHT_FLAG_W', 'UMOL/KG', 'phos_flag', '%d'
        'ALKALI', 'UMOL/KG', 'alk', '%8.1f'
        'ALKALI_FLAG_W', 'UMOL/KG', 'alk_flag', '%d'
        'TCARBN', 'UMOL/KG', 'dic', '%8.1f'
        'TCARBN_FLAG_W', 'UMOL/KG', 'dic_flag', '%d'
        'CFC-11', 'PMOL/L', 'cfc11', '%8.3f'
        'CFC-11_FLAG_W', 'PMOL/L', 'cfc11_flag', '%d'
        'CFC-12', 'PMOL/L', 'cfc12', '%8.3f'
        'CFC-12_FLAG_W', 'PMOL/L', 'cfc12_flag', '%d'
        'CFC113', 'PMOL/L', 'f113', '%8.3f'
        'CFC113_FLAG_W', 'PMOL/L', 'f113_flag', '%d'
        'CCL4', 'PMOL/L', 'ccl4', '%8.3f'
        'CCL4_FLAG_W', 'PMOL/L', 'ccl4_flag', '%d'
        'SF6', 'FMOL/L', 'sf6', '%8.3f'
        'SF6_FLAG_W', 'FMOL/L', 'sf6_flag', '%d'
        'SF5CF3', 'FMOL/L', 'sf5cf3', '%8.3f'
        'SF5CF3_FLAG_W', 'FMOL/L', 'sf5cf3_flag', '%d'
        'DELC14', '/MILLE', 'del14c', '%8.2f'
        'DELC14_FLAG_W', '/MILLE', 'del14c_flag', '%d'
        'DELC13', '/MILLE', 'del13c', '%8.2f'
        'DELC13_FLAG_W', '/MILLE', 'del13c_flag', '%d'
        'DELO18', '/MILLE', 'del18o', '%8.4f'
        'DELO18_FLAG_W', '/MILLE', 'del18o_flag', '%d'
